...
rename sexPulse sex
gen age_at_test=agePulse+(date("16NOV2020","DMY")-date(attendanceDate,"DMY"))/365.25
sum sex age_at_test
...
insheet using "Data_INTERVAL_latest/INTERVAL_Covid_16NOV2020.csv", case clear
sort identifier
#delimit ;
...
program C2sex
  ...
  outsheet ID SARS_CoV `4' PC_1-PC_20 using `1'/work/INTERVAL-covid.txt, delim(" ") noquote replace
...
C2age 20201116-le_60-ANA_C2_V2 1
C2age 20201116-gt_60-ANA_C2_V2 2
