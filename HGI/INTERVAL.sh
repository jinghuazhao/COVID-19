...
# for dir in ${d}-le_60-ANA_C1_V2 ${d}-le_60-ANA_C2_V2 ${d}-gt_60-ANA_C1_V2 ${d}-gt_60-ANA_C2_V2
for dir in ${d}-le_60-ANA_C2_V2 ${d}-gt_60-ANA_C2_V2
do
  export dir=${dir}
  Cx_V2_step1
  Cx_V2_step1_X
...
do
  export dir=${dir}
  sbatch ${SCALLOP}/HGI/autosomes.sb
